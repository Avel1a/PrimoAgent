...
SUPPORTED_INDICATORS = ['SMA', 'EMA', 'RSI', 'MACD', 'BBANDS', 'ADX', 'CCI', 'SMA200']
            ...
            try:
                ...
                if indicator == 'SMA':
                    ...
                    if len(close_series) < 200:
                        results[indicator] = []
                        continue
                    sma_indicator = SMAIndicator(close=close_series, window=200)
                    result = sma_indicator.sma_indicator()
                    ...
                    if len(close_series) < 20:
                        results[indicator] = {'upper': [], 'middle': [], 'lower': []}
                        continue
